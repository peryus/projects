      ...
      >
        ...
        <div className="mt-6">
          ...
          <DatePicker
              ...
              disabled={orderStatus === 'loading'}
              className="w-full border border-neutral-300 px-4 py-3 outline-none focus:border-neutral-900 disabled:cursor-not-allowed disabled:bg-neutral-100"
          />
        </div>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
              ...
              disabled={orderStatus === 'loading'}
              className="rounded-md bg-neutral-900 px-5 py-3 text-white disabled:cursor-not-allowed disabled:opacity-50"
          >
            {orderStatus === 'loading'
                ? 'Placing order...'
                : 'Checkout'}
